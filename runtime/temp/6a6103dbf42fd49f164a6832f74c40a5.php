<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"E:\GitHub-Project\o2oeshop\public/../application/admin\view\index\index.html";i:1506928525;s:78:"E:\GitHub-Project\o2oeshop\public/../application/admin\view\public\header.html";i:1506162299;s:76:"E:\GitHub-Project\o2oeshop\public/../application/admin\view\public\menu.html";i:1506928877;s:78:"E:\GitHub-Project\o2oeshop\public/../application/admin\view\public\footer.html";i:1506162248;}*/ ?>
﻿<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        <a href="#" class="dropDown_A"><?php echo \think\Session::get('adminAccount')['adminname']; ?><i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-bisLocation">
			<dt><i class="Hui-iconfont">&#xe620;</i> 商家分店管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="<?php echo url('bisLocation/index'); ?>" data-title="审核商家入驻申请" href="javascript:void(0)">审核商家门店申请</a></li>
					<li><a data-href="<?php echo url('bisLocation/dellist'); ?>" data-title="删除的商家入驻申请" href="javascript:void(0)">删除的商家门店申请</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo url('deal/check'); ?>" data-title="意见反馈" href="javascript:void(0)">商家团购审核</a></li>
					<li><a data-href="<?php echo url('deal/index'); ?>" data-title="评论列表" href="javascript:;">团购商品列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo url('featured/add'); ?>" data-title="会员列表" href="javascript:;">添加推荐位内容</a></li>
					<li><a data-href="<?php echo url('featured/index'); ?>" data-title="删除的会员" href="javascript:;">推荐位内容列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
