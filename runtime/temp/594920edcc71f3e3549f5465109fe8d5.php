                        ...
                        <form action="<?php echo url('user/login'); ?>" method="post">
                            <div class="ordinaryLogin">
                                ...
                                <p class="pass-form-item">
                                    ...
                                    <input type="text" name="captcha" class="pass-text-input" placeholder="密码">
                                    <div><img src="<?php echo captcha_src(); ?>" alt="captcha" onclick="this.src=this.src+'?'" style="width:100%;"/></div>
                                </p>
