...
<div class="page-container">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tbody>
            <?php foreach($delCategoryData as $vo): ?>
            <tr class="text-c">
                ...
                <td class="td-status"><a href="<?php echo url('category/status',['id'=>$vo['id'] ,'status' => $vo['status']=0]); ?>" title="点击还原为待审状态"><?php echo status($vo['status']); ?></a></td>
                <td class="td-manage"><a href="<?php echo url('category/index',[ 'parent_id' => $vo['id'] ]); ?>">获取子栏目</a>
                    <a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('category/status',[ 'id' => $vo['id'], 'status' => 0 ]); ?>','')" href="javascript:;" title="还原为待审"><i class="Hui-iconfont">&#xe6e2;</i></a>
                </td>
            </tr>
            <?php endforeach; ?>
            </tbody>
