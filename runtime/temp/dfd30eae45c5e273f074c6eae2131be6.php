<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"E:\GitHub-Project\o2oeshop\public/../application/bis\view\register\index.html";i:1505634316;s:76:"E:\GitHub-Project\o2oeshop\public/../application/bis\view\public\header.html";i:1505568789;s:76:"E:\GitHub-Project\o2oeshop\public/../application/bis\view\public\footer.html";i:1505568844;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-2">
				...
				<select name="city_id" class="select cityId">
					...
					<?php foreach($firstNormalCity as $vo): ?>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3"> <span class="select-box">
				<select name="category_id" class="select categoryId">
					<option value="0">--请选择--</option>
					<?php foreach($firstNormalCategory as $vo): ?>
					<option value="<?php echo $vo['id']; ?>"><?php echo $vo['name']; ?></option>
					<?php endforeach; ?>
				</select>
				</span>
